...
public class Oppgave2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Listen f�r sortering " + listen);
		...
		BiFunction<Integer, Integer, Integer> sumfunction = (a, b) -> a + b;// angir hva funksjonen skal gj�re
		...
		System.out.println("Beregn st�rste tall av -5 og 3: [" + storste + "]");
	...
	public static int beregn(int a, int b, BiFunction<Integer, Integer, Integer> funksjon) {
		return funksjon.apply(a, b); // funksjon skal implementeres p� variablene vi sendte
	}
}
